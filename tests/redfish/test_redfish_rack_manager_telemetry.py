...
def _parse_timestamp(value):
    try:
        ...
        pytest.fail("timestamp {!r} is not in bridge format {!r}".format(value, TIMESTAMP_FORMAT))
    ...
    def test_submit_telemetry_bridge_unavailable(self, redfish_client, bmc_duthost,
        ...
        try:
            ...
            try:
                ...
                pytest.fail("bmcweb did not answer SubmitTelemetry while {} was stopped: {}".format(
                    BRIDGE_PROGRAM, e))
